  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="sm:hidden">
        <Link href="/content/subjects/create" className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-emerald-600 px-5 py-3 text-white shadow hover:bg-emerald-700">
