...
const teacherNavItems: NavItem[] = [
  ...
  { href: "/parent-teacher/dashboard/teacher/stories", label: "Stories", icon: "solar:book-2-bold" },
...
const headTeacherNavItems: NavItem[] = [
  ...
  { href: "/parent-teacher/dashboard/headteacher/stories", label: "Stories", icon: "solar:book-2-bold" },
